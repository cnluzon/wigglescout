...
Plots a scatter plot from two given bigWig files and an optional set of
BED files as highlighted annotations. Bins are highlighted if there is
...
- density:
  ...
  Plot 2d histogram instead (deprecated - use plot_bw_bins_density
  instead)
