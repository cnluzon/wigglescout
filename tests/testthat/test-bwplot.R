...
# GRanges scatter tests -------------------------------------------

test_that("plot_gr_scatter with defaults returns a plot", {
  gr <- readRDS(testthat::test_path("fixtures", "mini_bins_all.rds"))
  p <- plot_gr_scatter(gr, "x", "y")
  expect_is(p, "ggplot")
})

test_that("plot_gr_density with defaults returns a plot", {
  gr <- readRDS(testthat::test_path("fixtures", "mini_bins_all.rds"))
  p <- plot_gr_density(gr, "x", "y")
  expect_is(p, "ggplot")
})
